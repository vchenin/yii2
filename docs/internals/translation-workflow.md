...
1. Check `framework/messages/config.php` and make sure your language is listed in `languages`. If not,
   ...
   `ru`, `zh-CN`.
2. Go to `framework` and run `./yii message/extract messages/config.php your_language`.
...
In order to keep your translation up to date you may run `./yii message/extract messages/config.php your_language` again. It will
